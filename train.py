...
dataset_train = Dataset("data/Train", "png", num_parallel_calls=tf.data.experimental.AUTOTUNE, is_training=True, target_shape=target_shape)

dataset_test = Dataset("data/Test", "png", num_parallel_calls=tf.data.experimental.AUTOTUNE, is_training=False, target_shape=target_shape)
...
dm.model.compile(optimizer=opt, loss=loss, metrics=metrics)
